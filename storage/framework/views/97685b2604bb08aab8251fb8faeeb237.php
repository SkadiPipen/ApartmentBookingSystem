...
<div id="app" class="flex justify-between w-full">
    ...
    <aside class="w-64 bg-gray-800 min-h-screen p-4 space-y-6" style="font-family: 'Playfair Display';">
        ...
        <nav class="space-y-8 flex flex-col text-white text-xl" style="font-family: 'Playfair Display';">
            <ul class="mt-6 space-y-2">
                ...
                <li class="relative px-3 py-3 flex-row">
                    <a href="<?php echo e(url('/MaintenanceReq')); ?>"
                ...
                <li class="relative px-3 py-3 flex-row">
                    <a href="admin-paymentHistory.html"
                       class="relative inline-flex items-center justify-start px-3 py-3 overflow-hidden text-sm font-semibold transition-all bg-gray-800 rounded hover:bg-white group"
                       style="flex: 1;">
                            <span
                                class="w-48 h-48 rounded rotate-[-40deg] bg-[#ffc329] absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
    ...
    <main class="flex flex-col p-6 w-full">
        ...
        <div class="flex justify-between items-center">
            <h2 class="text-3xl font-bold text-white" style="font-family: 'Playfair Display';"><?php echo e("Dashboard"); ?></h2>
        ...
        <section v-if="currentSection === 'adminDashboard'">
            ...
            <div class="grid grid-cols-4 gap-4 my-6 text-white">
                <div class="bg-gray-800 p-4 rounded-lg text-center">
                    ...
                    <p style="font-family: 'Playfair Display';" class="font-normal">Total Tenants</p>
                    <p class="text-lg font-semibold">6389</p>
                </div>
                <div class="bg-gray-800 p-4 rounded-lg text-center">
                    <div class="text-green-400 text-2xl">💰</div>
                    <p style="font-family: 'Playfair Display';" class="font-normal">Total balance</p>
                    <p class="text-lg font-semibold">$46,760.89</p>
                </div>
                <div class="bg-gray-800 p-4 rounded-lg text-center">
                    <div class="text-blue-400 text-2xl">🛒</div>
                    <p style="font-family: 'Playfair Display';" class="font-normal">Rooms Available</p>
                    <p class="text-lg font-semibold">376</p>
                </div>
                <div class="bg-gray-800 p-4 rounded-lg text-center">
                    <div class="text-cyan-400 text-2xl">💬</div>
                    <p style="font-family: 'Playfair Display';" class="font-normal">Pending Request</p>
                                        ...
                                        <tr>
                                            <td class="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                                <div class="inline-flex items-center gap-x-3">
                                                    <span>#<?php echo e($tenant->tenant_id); ?></span>
                                                </div>
                                            </td>
                                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                $<?php echo e(number_format($tenant->amount, 2)); ?>

                                            </td>
                                            <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <?php if($tenant->status == 'paid'): ?>
                                                ...
                                                <?php elseif($tenant->status == 'overdue'): ?>
                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                <?php echo e($tenant->check_in_date->format('M d, Y')); ?>

                                            </td>
                                            <td class="px-4 py-4 text-sm dark:text-gray-300">
                                                <?php echo e($tenant->check_out_date->format('M d, Y')); ?>
...
<?php /**PATH C:\Users\JOHN MARK MAGDASAL\OneDrive\Desktop\PHP\Dormnest\resources\views/admin_dashboard.blade.php ENDPATH**/ ?>